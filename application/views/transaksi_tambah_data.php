                        ...
                        <div class="col-md-8">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <form action="<?php echo base_url('Transaksi/save_tambah_data'); ?>" method="POST">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="control-label">Nama Pelanggan</label>
                                                    <select class="form-control" name="id_pelanggan" size="1" id="nama_pelanggan">
                                                        <?php foreach ($nama as $nama_pelanggan) { ?>
                                                           
                                                            <option value="<?php echo $nama_pelanggan['idpelanggan']; ?>"><?php echo $nama_pelanggan['name']; ?></option>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group label-floating">
                                                    ...
                                                    <input name="id_order" type="text" class="form-control" value="">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                        ...
                                        <button type="submit" class="btn btn-primary pull-right">Tambah Data Transaksi</button>
