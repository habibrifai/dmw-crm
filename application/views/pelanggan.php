                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header" data-background-color="purple">
                                    ...
                                    <p class="category">Daftar pelanggan</p>
                                    <a href="<?php echo base_url('Pelanggan/tambah_pelanggan'); ?>"><button style="background: #FFF; color: #9c27b0;" class="btn btn-primary">Tambah Data Pelanggan</button></a>
                                </div>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $data_pelanggan['prioritas']; ?></td>
                                                <td>ini belom</td>
                                                <td><?php echo $data_pelanggan['transaction_count']; ?></td>
                                                <td>ini belom</td>
                                                <td>
                                                    <a href="<?php echo base_url('Pelanggan/profile/').$data_pelanggan['idpelanggan']; ?>"><button class="btn btn-sm btn-themecolor">Edit</button></a>
                                                    <a href="<?php echo base_url('Pelanggan/profile/').$data_pelanggan['idpelanggan']; ?>"><button class="btn btn-sm btn-warning">Riwayat Transaksi</button></a>
                                                </td>
                                            </tr>
